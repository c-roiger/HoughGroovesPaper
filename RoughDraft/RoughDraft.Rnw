...
\hh{XXX I think this is less an issue of error and more an issue of repeatability. The methods are not described in enough detail for us to replicate what was done and the results from these manual steps are not being published anywhere.}
...
<<hessian-graphic-inclusion, echo = FALSE, fig.align="center", message=FALSE, warning = F, out.width= "50%", fig.cap= "Example of Hessian Normal Form parametrization overlaid a bullet scan">>=
...
<<xbottom-graphic-inclusion, echo = FALSE, fig.align="center", message=FALSE, warning = F, out.width= "50%", fig.cap= "Demonstration of calculation of bottom intercept of a bullet land using SOH-CAH-TOA">>=
...
<<max-graphic-inclusion, echo = FALSE, fig.align="center", message=FALSE, warning = F, out.width= "50%", fig.cap= "Demonstration of calculation of theoretical maximum score">>=
...
<<phoenix-lh-score-dist, echo = FALSE, fig.align="center", message=FALSE, warning = F, fig.height=3, fig.cap = "Distribution of left-hand areas of misidentification for Phoenix set">>=
...
<<phoenix-rh-score-dist, echo = FALSE, fig.align="center", message=FALSE, warning = F, fig.height=3, fig.cap = "Distribution of right-hand areas of misidentification for Phoenix Set">>=
...
<<phoenix-rh-score-dist-filtered, echo = FALSE, fig.align="center", message=FALSE, warning = F, fig.height=3, fig.cap = "Distribution of right-hand areas of misidentification with Rollapply scores filtered for Phoenix Set">>=
