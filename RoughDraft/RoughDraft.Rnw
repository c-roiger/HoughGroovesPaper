...
<<signal-motivation, echo = FALSE, fig.align="center", message=FALSE, warning = F, fig.height = 4, fig.cap= "Signatures corresponding to the above profile with properly specified and improperly specified locations of the left groove.">>=
