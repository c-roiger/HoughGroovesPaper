...
<<r setup, warning = F, messages = F, echo= FALSE, cache=FALSE>>=
...
<<r crosscut-motivation, echo=FALSE, fig.align="center", message=FALSE, fig.height = 3,  fig.cap="Profile of a land engraved area (LEA), left and right groove locations are marked as vertical lines.">>=
