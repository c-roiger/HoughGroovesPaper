...
<<r setup, warning = F, message = F, echo= FALSE, cache=FALSE>>=
...
<<r crosscut-motivation, echo=FALSE, fig.align="center", message=FALSE, warning = F, fig.height = 3,  fig.cap="Profile of a land engraved area (LEA), left and right groove locations are marked as vertical lines.">>=
...
<<r signal-motivation-good, echo = FALSE, fig.align="center", message=FALSE, warning = F, fig.height = 3, fig.cap= "Single signature with properly identified groove engraved areas">>=

sigs <- cc_get_signature(ccdata, grooves, span1 = 0.75, span2 = 0.3)
...
<<r signal-motivation-bad, echo = FALSE, fig.align="center", message=FALSE, warning = F, fig.height = 3, fig.cap= "Single signature with improperly identified groove engraved areas">>=
grooves.bad <- list("groove" = c(grooves$groove[1] -50, grooves$groove[2] - 50))

sigs <- cc_get_signature(ccdata, grooves.bad, span1 = 0.75, span2 = 0.3)
...
<<r strong-edge, echo = FALSE, fig.align="center", message=FALSE, warning = F, fig.height = 3, fig.cap= "Land Engraved Areas with Edges with magnitudes in the 99th percentile">>=
...
<<r canny-edge, echo = FALSE, fig.align="center", message=FALSE, warning = F, fig.height = 3, fig.cap= "Land Engraved Areas with Edges enhanced with Canny Edge Detection">>=
...
<<r hessian-example, echo = FALSE, fig.align="center", message=FALSE, warning = F, eval = F, fig.height = 3, fig.cap= "Example of Hessian Normal Form parametrization overlaid a bullet scan">>=
...
<<r hessian-graphic-inclusion, echo = FALSE, fig.align="center", message=FALSE, warning = F, out.width= "50%", fig.cap= "Example of Hessian Normal Form parametrization overlaid a bullet scan">>=
...
<<r calc-xbottom, echo = FALSE, fig.align="center", message=FALSE, warning = F, eval = F, fig.height = 3, fig.cap= "Demonstration of calculation of bottom intercept of a bullet land using SOH-CAH-TOA">>=
...
<<r xbottom-graphic-inclusion, echo = FALSE, fig.align="center", message=FALSE, warning = F, out.width= "50%", fig.cap= "Demonstration of calculation of bottom intercept of a bullet land using SOH-CAH-TOA">>=
...
<<r calc-theoretical-max, echo = FALSE, fig.align="center", message=FALSE, warning = F, eval = F, fig.height = 3, fig.cap= "Demonstration of calculation of theoretical maximum score">>=
...
<<r max-graphic-inclusion, echo = FALSE, fig.align="center", message=FALSE, warning = F, out.width= "50%", fig.cap= "Demonstration of calculation of theoretical maximum score">>=
...
<<r middle-fifty, echo = FALSE, fig.align="center", message=FALSE, warning = F, fig.height = 3, fig.cap= "Land Engraved Areas with Edges with magnitudes in the 99th percentile">>=
...
\end{center}
 ...
 <<r get-mask-hough-example-code, echo = FALSE, fig.align="center", message=FALSE, warning = F, eval = F, fig.height = 3, fig.cap= "Hough groove estimate visualized over whole of bullet land with adjust set to 30">>=
...
To improve the accuracy of the Hough transform, we have decide to impute areas of missing information in bullet lands. Missing information in the land is filled in with a value that is 5\% greater than the maximum height value detected in the bullet land.
 ...
 <<r five-percent-imputed-code, echo = FALSE, fig.align="center", message=FALSE, warning = F, eval = F, fig.height = 3, fig.cap= "Bullet land with imputed missing values">>=
...
<<r phoenix-lh-score-dist, echo = FALSE, fig.align="center", message=FALSE, warning = F, fig.height=3, fig.cap = "Distribution of left-hand areas of misidentification for Phoenix set">>=
phoenix.df <- readRDS("../data/phoenix-rollapply-hough-scores-no-adjusts.rds")

phoenix.df %>%
  ggplot()+
  geom_density(aes(x = score_left_hough), fill = "orange", alpha = 0.5)+
  geom_density(aes(x= score_left_rollapply), fill = "purple", alpha = 0.5) +
  xlab("Area of Misidentification Scores")
...
<<r phoenix-rh-score-dist, echo = FALSE, fig.align="center", message=FALSE, warning = F, fig.height=3, fig.cap = "Distribution of right-hand areas of misidentification for Phoenix Set">>=

phoenix.df %>%
  ggplot()+
  geom_density(aes(x = score_right_hough), fill = "orange", alpha = 0.5)+
  geom_density(aes(x= score_right_rollapply), fill = "purple", alpha = 0.5) +
  xlab("Area of Misidentification Scores")
...
<<r phoenix-rh-score-dist-filtered, echo = FALSE, fig.align="center", message=FALSE, warning = F, fig.height=3, fig.cap = "Distribution of right-hand areas of misidentification with Rollapply scores filtered for Phoenix Set">>=

ggplot()+
  geom_density(data = phoenix.df, aes(x = score_right_hough), fill = "orange", alpha = 0.5)+
  geom_density(data = phoenix.df %>% dplyr::filter(score_right_rollapply < 5948), aes(x= score_right_rollapply), fill = "purple", alpha = 0.5) +
  xlab("Area of Misidentification Scores")
...
<<r hamby44-lh-score-dist, echo = FALSE, fig.align="center", message=FALSE, warning = F, fig.height=3, fig.cap = "Distribution of left-hand areas of misidentification for Hamby 44 Set">>=
