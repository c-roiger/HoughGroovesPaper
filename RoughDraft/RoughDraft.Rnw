...
<<r hessian-example, echo = FALSE, fig.align="center", message=FALSE, warning = F, fig.height = 3, fig.cap= "Land Engraved Areas with Edges with magnitudes in the 99th percentile">>=

p <- ggplot() +
  geom_segment(aes(x =1000, y = 0, xend = 0, yend = 250), lwd= 2, colour = "orange") +
  geom_segment(aes(x =0, y = 0, xend = 590, yend = 100), lwd= 2, colour = "deepskyblue1") +
  geom_curve(aes(x = 100, y = 0, xend = 50, yend = 10), lwd = 1, colour = "deepskyblue1", curvature = -0.7) + 
  geom_segment(aes(x = 580, y=73, xend = 650, yend = 85), lwd = 2, colour = "deepskyblue1") +
  geom_segment(aes(x = 520, y = 90, xend = 580, yend = 75), lwd = 2, colour = "deepskyblue1") +
  annotate('text', x = 150, y = 10, 
           label = "theta",parse = TRUE,size=6, colour = "#000000") +
...
cowplot::ggdraw() +
  cowplot::draw_image("../images/after-before.png", x = 0.05, y = 0, height = 1.25, width = 1) +
  cowplot::draw_plot(p)
@
% 
% \begin{figure}[ht!]
