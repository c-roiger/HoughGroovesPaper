...
\caption[Example of Hessian Normal Form parametrization overlaid a bullet scan]{Example of Hessian Normal Form parametrization overlaid a bullet scan}\label{fig:r hessian-graphic-inclusion}
\end{figure}
...
\caption[Demonstration of calculation of bottom intercept of a bullet land using SOH-CAH-TOA]{Demonstration of calculation of bottom intercept of a bullet land using SOH-CAH-TOA}\label{fig:r xbottom-graphic-inclusion}
\end{figure}
...
\caption[Demonstration of calculation of theoretical maximum score]{Demonstration of calculation of theoretical maximum score}\label{fig:r max-graphic-inclusion}
\end{figure}
...
\caption[Hough groove estimate visualized over whole of bullet land with adjust set to 120]{Hough groove estimate visualized over whole of bullet land with adjust set to 120}\label{fig:r get-mask-hough-example}
\end{figure}
...
{\centering \includegraphics[width=\maxwidth]{figure/r_phoenix-lh-score-dist-1} 

}

\caption[Distribution of left-hand areas of misidentification for Phoenix set]{Distribution of left-hand areas of misidentification for Phoenix set}\label{fig:r phoenix-lh-score-dist}
\end{figure}
...
{\centering \includegraphics[width=\maxwidth]{figure/r_phoenix-rh-score-dist-1} 

}

\caption[Distribution of right-hand areas of misidentification for Phoenix Set]{Distribution of right-hand areas of misidentification for Phoenix Set}\label{fig:r phoenix-rh-score-dist}
\end{figure}
...
{\centering \includegraphics[width=\maxwidth]{figure/r_phoenix-rh-score-dist-filtered-1} 

}

\caption[Distribution of right-hand areas of misidentification with Rollapply scores filtered for Phoenix Set]{Distribution of right-hand areas of misidentification with Rollapply scores filtered for Phoenix Set}\label{fig:r phoenix-rh-score-dist-filtered}
\end{figure}
...
{\centering \includegraphics[width=\maxwidth]{figure/r_hamby44-lh-score-dist-1} 

}

\caption[Distribution of left-hand areas of misidentification for Hamby 44 Set]{Distribution of left-hand areas of misidentification for Hamby 44 Set}\label{fig:r hamby44-lh-score-dist}
\end{figure}
